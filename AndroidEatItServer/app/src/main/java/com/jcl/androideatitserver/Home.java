...
import com.jcl.androideatitserver.Model.Category;
import com.jcl.androideatitserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    RecyclerView menu_reRecyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_reRecyclerView=findViewById(R.id.recycler_home);
        menu_reRecyclerView.setHasFixedSize(true);
        layoutManager=new LinearLayoutManager(this);
        menu_reRecyclerView.setLayoutManager(layoutManager);
        loadMenu();
    }
    ...
    private void loadMenu() {
        ...
        menu_reRecyclerView.setAdapter(adapter);
    }
